Для запуска нужно отредактировать файл `app/settings.py`, внеся в него корректные пути к папкам приложения, `static` и `templates`. Затем необходимо установить модули из `requirements.txt`:
